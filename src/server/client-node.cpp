...
const std::chrono::milliseconds&ClientNode::getDesiredInterval() const
{
    return desiredInterval;
}

const std::chrono::milliseconds&ClientNode::getMinimalInterval() const
{
    return minimalInterval;
}

core::AccuracyLevel ClientNode::getAccuracyLevel() const
{
...
void ClientNode::setProxy(ipc::Server::ClientProxy* proxy)
{
