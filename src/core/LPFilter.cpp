 ...
 */
fl::Result fl::core::LPFilter::reset(real samplingFrequencyHz)
{
	if (samplingFrequencyHz > 0) {
		double omegaC  = tan(M_PI * LPF_CUTOFF_FREQUENCY_HZ / samplingFrequencyHz);
 ...
 */
void fl::core::LPFilter::resetMemory(real uPast)
{
